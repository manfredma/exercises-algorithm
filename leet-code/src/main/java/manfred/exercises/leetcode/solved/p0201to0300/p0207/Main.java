...
public class Main {
    public static void main(String[] args) {
        ...
        assertEquals(true, solution5.canFinish(2, new int[][]{{1, 0}}));
        ...
        assertEquals(false, solution5.canFinish(2, new int[][]{{1, 0}, {0, 1}}));
        // 边界: 无先修课程 → 期望 true
        ...
        assertEquals(true, solution5.canFinish(3, new int[][]{}));
        // 边界: 单门课程 → 期望 true
        ...
        assertEquals(true, solution5.canFinish(1, new int[][]{}));
        // 边界: 长链无环 → 期望 true
        ...
        assertEquals(true, solution5.canFinish(4, new int[][]{{1, 0}, {2, 1}, {3, 2}}));
        ...
        assertEquals(true, solution5.canFinish(3, new int[][]{{0, 1}, {0, 2}, {1, 2}}));
        // 边界: 三元环 → 期望 false
        ...
        assertEquals(false, solution5.canFinish(3, new int[][]{{0, 1}, {1, 2}, {2, 0}}));
        ...
        assertEquals(false, solution5.canFinish(4, new int[][]{{1, 0}, {0, 1}, {2, 3}}));
