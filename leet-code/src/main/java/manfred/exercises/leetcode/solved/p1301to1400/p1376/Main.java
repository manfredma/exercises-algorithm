...
输出：1
解释：id = 2 的员工是公司的总负责人，也是其他所有员工的直属负责人，
他需要 1 分钟来通知所有员工。
...
题目保证所有员工都可以收到通知。
*/
/** LeetCode 第 1376 题的测试入口。 */
public class Main {
    public static void main(String[] args) {
        Solution solution = new Solution();
        Solution2 solution2 = new Solution2();
        assertExamples(solution);
        assertExamples(solution2);
    }

    private static void assertExamples(Solution solution) {
        assertEquals(0, solution.numOfMinutes(1, 0, new int[]{-1}, new int[]{0}));
        assertEquals(1, solution.numOfMinutes(6, 2, new int[]{2, 2, -1, 2, 2, 2},
                new int[]{0, 0, 1, 0, 0, 0}));
    }

    private static void assertExamples(Solution2 solution) {
        assertEquals(0, solution.numOfMinutes(1, 0, new int[]{-1}, new int[]{0}));
        assertEquals(1, solution.numOfMinutes(6, 2, new int[]{2, 2, -1, 2, 2, 2},
                new int[]{0, 0, 1, 0, 0, 0}));
    }
