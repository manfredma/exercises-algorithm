...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        assertExpressionSetEquals(
                Arrays.asList("1+2+3", "1*2*3"), solution.addOperators("123", 6), "123/6");
        assertExpressionSetEquals(
                Arrays.asList("1+2+3", "1*2*3"), solution2.addOperators("123", 6), "123/6");
        assertExpressionSetEquals(
                Arrays.asList("2*3+2", "2+3*2"), solution.addOperators("232", 8), "232/8");
        assertExpressionSetEquals(
                Arrays.asList("2*3+2", "2+3*2"), solution2.addOperators("232", 8), "232/8");
        ...
        assertExpressionSetEquals(
                Arrays.asList("0+0", "0-0", "0*0"), solution.addOperators("00", 0), "00/0");
        assertExpressionSetEquals(
                Arrays.asList("0+0", "0-0", "0*0"), solution2.addOperators("00", 0), "00/0");
        System.out.println("p0282 all assertions passed");
    }
