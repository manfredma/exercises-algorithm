...
5. **归档**：`wip/pXXXX/` 整目录迁移到 `solved/pXXXXtoYYYY/pZZZZ/`（题号所在连续百题段），同步更新所有 `.java` 的 package 声明。
...
迁移整个目录到 `leet-code/src/main/java/manfred/exercises/leetcode/solved/pXXXXtoYYYY/pZZZZ/`，其中范围是题号所在连续百题段；例如 328 归档到 `solved/p0301to0400/p0328/`。同步更新该题的 package 声明与所有跨题 import。
